...
const ProtectedRoute = ({ children }) => {
  ...
  //         dispatch(SetUser(response.data));
  //       } else {
  //         console.log("Token Deleted: API Call Failed");
  //         dispatch(SetUser(null));
  //         message.error(response.message);
  //         localStorage.removeItem("token"); // <-- This is where it's getting deleted
  //         navigate("/login");
  //       }
  //     } catch (error) {
  //       dispatch(HideLoading());
  //       dispatch(SetUser(null));
  //       console.log("Token Deleted: Exception Occurred", error);
